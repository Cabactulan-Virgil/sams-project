...
export default function Login() {
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-blue-50 via-white to-indigo-50 flex flex-col justify-center py-12 px-4 sm:px-6 lg:px-8">
      ...
      <div className="mx-auto w-full max-w-5xl grid gap-10 lg:grid-cols-2 items-center">
        <div className="space-y-6">
          <p className="text-sm font-semibold text-blue-600 uppercase tracking-wide">
            Student Attendance Monitoring System
          </p>
          <h1 className="text-3xl sm:text-4xl font-bold text-gray-900">
            Welcome to Student Attendance Monitoring System
          </h1>
          <p className="text-base text-gray-600">
            Manage, monitor, and record attendance with ease and efficiency.
          </p>
          <p className="text-sm text-gray-500">
            Student Attendance Monitoring System is a web-based attendance system where teachers can record
            and monitor student attendance efficiently.
          </p>
        </div>
          ...
          {registered && !error && (
            <div className="mb-4 bg-green-50 border-l-4 border-green-400 p-4">
              <div className="flex">
                ...
                <div className="ml-3">
                  <p className="text-sm text-green-700">Your account was created successfully. You can now sign in.</p>
                </div>
              </div>
            </div>
          )}
